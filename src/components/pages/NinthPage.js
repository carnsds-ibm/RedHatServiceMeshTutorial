...
const NinthPage = () => (
    <Content>
        ...
        <UnorderedList>
            <ListItem>
                <BodyText SM text="Make sure MESH_PROJ and APP_PROJ are still set one last time, then run the following command to delete your projects and relieve your clusters a little bit, if you wish." />
                <BodyText text="(Optional) Cleanup" />
            ...
            <ListItem>
                ...
                under the guidance of GSE within IBM. A big Thanks to CPAT within IBM for the opportunity given here to learn about these cloud native solutions like Service Mesh. Finally, thank YOU for taking the time to run through the tutorial and I hope I helped at least a little bit learn more about Red Hat OpenShift - Maistra Service Mesh.`} />
            </ListItem>
        </UnorderedList>
    </Content>
);
